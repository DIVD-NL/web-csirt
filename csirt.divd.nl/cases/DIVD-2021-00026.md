...
Microsoft’s Open Management Interface (OMI) for Linux servers which is shipped with Azure, LogAnalytics, Microsoft SystemCenter when using it to manage Linux servers, and potentially more software and services; had a critical vulnerability that made it possible to execute code remotely. We have tried to scan for this vulnerability, however the amount of internet-facing OMI instances is quite low and none of them seemed vulnerable to OMIGOD.
