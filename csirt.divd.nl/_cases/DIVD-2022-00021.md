...
- start: 2021-12-02
  ...
  event: Invanti publishes security advisory
- start: 2022-02-24 
  end:
  event: Invanti updates security advisory
- start: 2022-03-20
  end:
...
If you are unable to update, SSH in to the CSA and execute the following command:
