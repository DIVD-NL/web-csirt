...
product: Zimbra
versions: Zimbra version 8.8.15 P30 (8.8.15_GA_4203) and all prior versions.
recommendation: "Users of Zimbra version 8.8.15 need to re-apply the patch P30 (8.8.15_GA_4232) to obtain the fix for this vulnerability or should consider upgrading to version 9.0.0"
-workaround: n/a
start: 2021-12-14
end:
timeline:
...
## What you can do
* Users of Zimbra version 8.8.15 need to re-apply the patch P30 (8.8.15_GA_4232) to obtain the fix for this vulnerability 
