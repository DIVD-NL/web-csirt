...
On November 13th 2025, The Dutch National Police, in cooperation with EuropPol, Eurojust and […] took down [xxx] botnets under the name of [xxxxx] in a another episode of [Operation Endgame](https://operation-endgame.com/), the biggest continued anti-botnet operation to date. During this takedown, the stolen data has been seized.
...
NCSC, DTC, DIVD and [xxxxx] are notifying everyone in the dataset we are able to reach.
...
## What you must do
Whilest we analyse the data, this section will be updated. Please act immediately if you receive a notification email from us. Instructions can be found in the email and below.
<!---
...
We are now analysing the received data, once finished we’ll start victim notification. Therefore we work by our stolen credentials policy.  [stole credentials policy](/credentials/)

###Details of this operation
- [link]
- [operation endgame]
- [press release Europol]
- [press release Dutch National Police] 
- [divd./nl/case] 
