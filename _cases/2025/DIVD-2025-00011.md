...
title: Severe vulnerabilities in Growatt portal
...
- start: 2025-10-21
  event: Vulnerability reappears due to regression
- start: 2025-10-28
  event: Humza Ahmed finds more severe vulnerabilities in portal
- start: 2024-12-05
  event: Growatt contacted again
...
## More information
* {% cve CVE-2025-29757 %}
* [https://oss.growatt.com](https://oss.growatt.com) - URL 1
* [https://server.growatt.com](https://server.growatt.com) - URL 2
