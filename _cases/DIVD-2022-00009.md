...
Getting the account closed turns out to be hard. The first time the vendor responded promptly, but silently. In fact neither we nor the NSCS even got any reply from them. NCSC used the help of the Dutch Embassy in CHina and head of research Victor Gevers visited the Chineese Embassy in The Hague, all in an effort to het into contact. In the end the password has been changed and the repository deleted. Just before this Cert China confirmed receipt of the report to NCSC.
