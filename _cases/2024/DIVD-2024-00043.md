...
- CyberAudit-Web before version 9.5 (CVE-2025-22367)
...
The two vulnerabilities include a Server-Side Request Forgery vulnerability in older versions of the videx-legacy-ssl library and an Authentication Bypass in CyberAudit-Web versions before 9.5, which are End-of-Maintenance. Acknowledging the severity, CyberLock has made a patch available for both customers with and without support contract.
