...
- SolarWinds U-Serv
versions: 
- Everything lower than 15.4.2.157 (Hotfix 2)
recommendation: "Install the provided hotfix as soon as possible to patch the vulnerability."
workaround: "None"
...
SolarWinds released a hotfix for version 15.4.2. Install this hotfix as soon as possible, the corresponding version number is 15.4.2.157.
