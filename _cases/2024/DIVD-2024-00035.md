...
Iocharger has fixed the following 13 vulnerabilities:
...
The vulnerabilities have been fixed in firmware version 24120701 which is applicable to all AC Chargers manufactured by Iocharger. Iocharger does not have a website where the firmware can be downloaded or release notes or security bulletins can be viewed. Instead Iocharger has made their distributor(s) aware that a firmware update that fixes security findings exists. If as an owner you have not been contacted by your distributor/vendor we advice you to reach out to them for updated firmware. If you cannot get support from your vendor/distributor you can contact Iocharger directly on sales@iocharger.com to get updated firmware.
