---
layout: case
title: "Unauthenticated RCE in Rejetto HTTP File Server (CVE-2024-23692) "
...
* [Proof of Concept Blog CVE-2024-23692](https://mohemiv.com/all/rejetto-http-file-server-2-3m-unauthenticated-rce/)
