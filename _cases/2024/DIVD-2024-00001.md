...
- start: 2024-01-17
  ...
  event: “Based on the information from Rapid7, DIVD csirt has developed a scanning method and will start scanning for hosts that are vulnerable to the authentication bypass."
