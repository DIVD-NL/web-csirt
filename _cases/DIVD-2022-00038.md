...
In January '22 Oracle announced a critical patch update to mitigate multiple security vulnerabilities. DIVD started notifying owners of IP addresses where instances vulnerable to CVE-2022-21371 were found. A patch is available to mitigate this issue. Recipients of this email are advised to immediately update their Oracle WebLogin instance.
